...
class GroupListTests: XCTestCase {
    ...
    func testGetters() {
        ...
        XCTAssert(groupList[1].name == "Group2")
        XCTAssert(groupList[2].name == "Group3")
        XCTAssert(groupList[3].name == GroupList.defaultGroupName)
    ...
    func testThingAdd() {
        ...
        XCTAssert(groupList[3].thingCount == 1)
        XCTAssert(groupList[3].thing(at: 0) == "Thinga")
        ...
        XCTAssert(groupList[1].thing(at: 2) == "Thing3")
